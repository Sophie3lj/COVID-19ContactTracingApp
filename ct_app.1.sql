...
INSERT INTO `hotspots` VALUES (1,NULL,NULL),(2,NULL,NULL);
...
CREATE TABLE `suburbs` (
  ...
  CONSTRAINT `suburbs_ibfk_1` FOREIGN KEY (`hotspot_id`) REFERENCES `hotspots` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suburbs` VALUES (1,'Unley',NULL),(2,'Eastwood',NULL),(3,'North Adelaide',1),(4,'Burnside',2);
